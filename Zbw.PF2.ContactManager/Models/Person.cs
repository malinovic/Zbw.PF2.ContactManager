...
/// <summary>
///     Base class for a natural person, holding the personal and contact details shared by
///     customers and employees.
/// </summary>
public class Person : QueryableEntity
{
    /// <summary>Gets or sets the person's salutation.</summary>
    ...
    /// <summary>Gets or sets the person's sex.</summary>
    public required Sex Sex { get; set; }
    /// <summary>Gets or sets the person's title.</summary>
    public required Title Title { get; set; }
    /// <summary>Gets or sets the person's address.</summary>
    public required Address Address { get; set; }
    /// <summary>Gets or sets the person's company phone number.</summary>
    public required string PhoneNumberCompany { get; set; }
    /// <summary>Gets or sets the person's mobile phone number.</summary>
